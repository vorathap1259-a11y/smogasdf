        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative aspect-[4/5] rounded-[2rem] overflow-hidden border border-white/10 shadow-[0_0_100px_rgba(139,92,246,0.15)] bg-zinc-900">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-white">Omer Sastim</h3>
            ...
            <motion.div 
              ...
              className="absolute top-4 -right-4 md:top-12 md:-right-8 glass-panel p-2.5 md:p-6 rounded-2xl border border-white/10 shadow-2xl z-20"
            >
              <div className="flex items-center gap-2 md:gap-4">
                <div className="w-7 h-7 md:w-12 md:h-12 rounded-full bg-pink-500/20 flex items-center justify-center">
                  <Instagram className="w-3.5 h-3.5 md:w-6 md:h-6 text-pink-500" />
                </div>
                <div>
                  <p className="text-[11px] md:text-sm text-gray-300">Instagram</p>
                  <p className="text-xs md:text-xl font-bold text-white [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">2M+ Followers</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute bottom-48 -left-4 md:bottom-32 md:-left-8 glass-panel p-2.5 md:p-6 rounded-2xl border border-white/10 shadow-2xl z-20"
            >
              <div className="flex items-center gap-2 md:gap-4">
                <div className="w-7 h-7 md:w-12 md:h-12 rounded-full bg-red-500/20 flex items-center justify-center">
                  <Youtube className="w-3.5 h-3.5 md:w-6 md:h-6 text-red-500" />
                </div>
                <div>
                  <p className="text-[11px] md:text-sm text-gray-300">YouTube</p>
                  <p className="text-xs md:text-xl font-bold text-white [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">27M+ Subs</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute top-4 -left-4 md:top-auto md:bottom-12 md:right-12 md:left-auto glass-panel p-2.5 md:p-6 rounded-2xl border border-white/10 shadow-2xl z-20 w-fit"
            >
              <div className="flex items-center gap-2 md:gap-4">
                <div className="w-7 h-7 md:w-12 md:h-12 rounded-full bg-white/10 flex items-center justify-center">
                  <svg className="w-3.5 h-3.5 md:w-6 md:h-6 text-white" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93-.01 2.92.01 5.84-.02 8.75-.03 1.4-.54 2.79-1.35 3.94-1.31 1.92-3.58 3.17-5.91 3.21-1.43.08-2.86-.31-4.08-1.03-2.02-1.19-3.44-3.37-3.65-5.71-.02-.5-.03-1-.01-1.49.18-1.9 1.12-3.72 2.58-4.96 1.66-1.44 3.98-2.13 6.15-1.72.02 1.48-.04 2.96-.04 4.44-.99-.32-2.15-.23-3.02.37-.63.41-1.11 1.04-1.36 1.75-.21.51-.15 1.07-.14 1.61.24 1.64 1.82 3.02 3.5 2.87 1.12-.01 2.19-.66 2.77-1.61.19-.33.4-.67.41-1.06.1-1.79.06-3.57.07-5.36.01-4.03-.01-8.05.02-12.07z"/>
                  </svg>
                </div>
                <div>
                  <p className="text-[11px] md:text-sm text-gray-300">TikTok</p>
                  <p className="text-xs md:text-xl font-bold text-white [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">2M+ Followers</p>
                </div>
              </div>
            </motion.div>
