        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <motion.div 
              ...
              className="absolute -right-8 top-12 glass-panel p-6 rounded-2xl border border-white/10 shadow-2xl z-20"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-white [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">2M+ Followers</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute -left-8 bottom-32 glass-panel p-6 rounded-2xl border border-white/10 shadow-2xl z-20"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xl font-bold text-white [text-shadow:_0_2px_10px_rgb(0_0_0_/_80%)]">27M+ Subs</p>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div 
              ...
              className="absolute right-12 bottom-12 glass-panel p-6 rounded-2xl border border-white/10 shadow-2xl z-20"
            >
              <div className="flex items-center gap-4">
